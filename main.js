...
function muteMusic() {
   if (paused == true) {
      gameMusic.play();
      document.getElementById("soundButton").innerHTML = "<ion-icon title='Mute' name='volume-high-outline'></ion-icon>"
      paused = false
   }
   else {
      gameMusic.pause();
      document.getElementById("soundButton").innerHTML = '<ion-icon title="Unmute" name="volume-mute-outline"></ion-icon>'
      paused = true
   }
}